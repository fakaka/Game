...
local events=
{
    ...
    EventHandler("attacked", function(inst)
        if inst.components.health and not inst.components.health:IsDead() then
            ...
            inst.SoundEmitter:PlaySound("millenniumfox/creatures/miho/close")
        end
    end),
...
local states=
{
    ...
    State{
        ...
        onenter = function(inst)
            inst.Physics:Stop()
            inst.AnimState:PlayAnimation("rest_loop")
        end,
    ...
    State{
        ...
        timeline=
        {
            TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("miho/miho/open") end),
        },     
    },
    ...
    State{
        ...
        timeline=
        {
            TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("miho/miho/close") end),
        },      
    },
    ...
    State{
        ...
        onenter = function(inst)
            ...
            --Remove ability to open miho for short time.
        ...
        onexit = function(inst)
            --Add ability to open miho again.
...
return StateGraph("miho", states, events, "idle", actionhandlers)
--------------------------------------------------------------------------------------------------------------------------JINYE